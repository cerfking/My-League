...
struct ChampionSquareView: View {
    private let champion: Champion
    init(champion: Champion) {
        self.champion = champion
    }
    var body: some View {
        AsyncImage(url: URL(string: "https://ddragon.leagueoflegends.com/cdn/14.2.1/img/champion/\(champion.image.full)"), content: { image in
            image
                .resizable()
                .scaledToFit()
